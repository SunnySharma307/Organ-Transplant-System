                        ...
                        <nav className="divide-y divide-slate-100">
                            {guidelinesData.map((item) => (
                                <button
                                    ...
                                    className={`w-full text-left p-4 text-sm font-medium flex items-center gap-3 transition-colors ${activeSection === item.id
                ...
                <div className="flex-1 space-y-6">
                    ...
                    {guidelinesData.map((section) => (
                        <section
                            key={section.id}
                            id={section.id}
                            className={`bg-white border border-slate-300 rounded-sm shadow-sm scroll-mt-24 transition-all duration-300 ${activeSection === section.id
