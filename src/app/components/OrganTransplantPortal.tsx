...
export function OrganTransplantPortal() {
                    ...
                    <div className="w-full max-w-lg bg-white border border-slate-300 shadow-md rounded-sm">
                        ...
                        <div className="p-6">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div className="bg-slate-50 border border-slate-200 p-3 flex items-center gap-3 rounded-sm my-2 select-none">
                                    <div
                                        onClick={handleCaptchaClick}
                                        className={`w-6 h-6 border-2 flex items-center justify-center rounded-sm cursor-pointer transition-all ${isCaptchaVerified
                                    ...
                                    <span className="text-sm text-slate-600" onClick={handleCaptchaClick}>
                                        I am not a robot
                                    </span>
                                    {isCaptchaVerified && (
